...
import { FinancialPortal } from "@/components/financial-portal"
...
export default function HomePage() {
  ...
  const [showFinancialPortal, setShowFinancialPortal] = useState(false)
  ...
  const liberationModules = [
    ...
    },
    {
      ...
      description: "Community-centered financial empowerment hub",
      icon: DollarSign,
      color: "from-green-500 to-emerald-500",
      action: () => setShowFinancialPortal(true),
      priority: "high",
      encrypted: true,
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden sigil-background">
        ...
        <section className="text-center space-y-6 carousel-slide">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button
              ...
              onClick={() => setShowFinancialPortal(true)}
            >
            ...
            <TabsContent value="support" className="mt-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className="liberation-card">
                  ...
                  <CardContent>
                    <p className="text-gray-600 mb-4">Community-centered financial empowerment and mutual aid.</p>
                    <Button
                      onClick={() => setShowFinancialPortal(true)}
      ...
      {showFinancialPortal && (
        <FinancialPortal isVisible={showFinancialPortal} onClose={() => setShowFinancialPortal(false)} />
      )}
    </div>
  )
}
